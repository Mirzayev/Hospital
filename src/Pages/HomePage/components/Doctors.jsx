        ...
        return (
            <>
                <div className='m-9 p-6 bg-white drop-shadow-md shadow-black mb-[55px] '>
                    ...
                    <div className='grid grid-cols-8 text-[14px] gap-5 font-bold pt-9'>
                    ...
                    <div>
                        {doctor.map((event) => {
                            return (
                                <div className='grid grid-cols-8 gap-5  text-[14px] text-[#52575C] py-[12px] font-semibold w-full overflow-x-auto '
                                     key={event.id}>
                                    ...
                                    <p className='col-span-1 flex items-center gap-3 ml-4'>
                                        ...
                                        <svg onClick={()=> deleteDoctor (event.id)  } className='cursor-pointer' width="12" height="14" viewBox="0 0 12 14" fill="none"
                                             xmlns="http://www.w3.org/2000/svg">
                                            <path
